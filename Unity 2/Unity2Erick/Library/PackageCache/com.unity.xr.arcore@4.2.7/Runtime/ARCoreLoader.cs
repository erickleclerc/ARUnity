...
namespace UnityEngine.XR.ARCore
{
    ...
    public class ARCoreLoader : XRLoaderHelper
    {
        ...
        static List<XRPointCloudSubsystemDescriptor> s_DepthSubsystemDescriptors = new List<XRPointCloudSubsystemDescriptor>();
        ...
        public XRPointCloudSubsystem depthSubsystem => GetLoadedSubsystem<XRPointCloudSubsystem>();
